...
class DayToobaWidget : AppWidgetProvider() {
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            val views = RemoteViews(context.packageName, R.layout.day_tooba_widget)
...
//    val views = RemoteViews(context.packageName, R.layout.day_tooba_widget)
//    views.setTextViewText(R.id.widget_value, widgetText)
//
