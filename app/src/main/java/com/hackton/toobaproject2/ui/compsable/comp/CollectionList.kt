    ...
    Column {
        ...
        Column(
            ...
            LazyColumn(
                ...
                items(count = 10) {
                    CollectionItemOne(
                        navigateToDetailCollection = navigateToDetailCollection::invoke
                    )
//                    CollectionItemTwo()
                }
            }
...
private fun CollectionItemOne(
    ...
    Card(
        ...
        ).clickable { navigateToDetailCollection.invoke() },
...
//            Image(
//                modifier = Modifier.fillMaxWidth(),
//                painter = painterResource(R.drawable.collection2),
//                contentDescription = null,
//                contentScale = ContentScale.FillWidth
//            )
//
